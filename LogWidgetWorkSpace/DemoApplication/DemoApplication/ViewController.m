...
//    BOOL result = [manager.fileManager createFile:@"123.jpg" relativePath:@"/ios/b/c" inPath:DOCUMENT_PATH_DOCUMENT overwrite:true baseData:nil error:nil];
//    NSLog(@"result: %d", result);
    UIImage *img = [UIImage imageNamed:@"1"];
    [manager.fileManager writeFileAtFullPath:[manager.fileManager getFullPathBy:DOCUMENT_PATH_DOCUMENT relativePath:@"/ios/b/c/123.jpg"] content:img error:nil];
}
